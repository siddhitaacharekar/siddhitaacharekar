...
timer_label = Label(text="TIMER" , fg=GREEN , font= (FONT_NAME , 50) , background=YELLOW)
timer_label.grid(row = 0 , column = 1)

start_button = Button(text="Start" , command=start_timer , highlightthickness=0)
start_button.grid(row = 3, column = 0)

restart_button = Button(text="Restart" , highlightthickness= 0 , command=reset )
restart_button.grid(row = 3, column = 3)

check_label = Label(  foreground=GREEN , background=YELLOW )
